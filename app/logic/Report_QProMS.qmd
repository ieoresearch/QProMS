...
r6$safe_report_plot(function() r6$plot_protein_coverage(), "Coverage is not available for this analysis.")
```
...
r6$safe_report_plot(function() r6$plot_protein_coverage_intersections(), "Intersection is not available for this analysis.")
```
...
In the following table are summarized all the parameters used by the QProMS software.
